...
Oh I hope you know what are buffer overflows, for if you don't head over to the [Bin-Exp]({% post_url /IITBreachers-wiki/2020-07-23-Binary Exploitation %}) please.

And if you're not familiar with assignments on this wiki, head over to [what are assignments]({% post_url /IITBreachers-wiki/2038-07-17-what are assignments %}).
